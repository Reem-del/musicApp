...
function Searchsongcard({song,collection,i}) {
    ...
    return (
       ...
       <div className='relative'>
        ...
        <img src='/images/output-onlinegiftools.gif' alt={song?.alias} className={`${isPlaying && activeSong?.alias === song.alias ? `absolute left-[50%] top-[50%] -translate-x-[50%] -translate-y-[50%]` : `hidden`}`} />
        </div>
